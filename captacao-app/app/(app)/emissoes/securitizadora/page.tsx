import { listarSecuritizadoras, listarCautelas, proximoCodigo } from "@/lib/cautelas-estoque";
  ...
  return (
    <div className="p-8">
      ...
      {empresas.length === 0 ? (
        ...
        <CautelasEstoqueAdmin empresas={empresas as any} cautelas={cautelas as any} sugestoes={sugestoes} />
      )}
    </div>
  );
}
